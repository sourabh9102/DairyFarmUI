...
import { selectAllProducts, selectFilteredProducts, selectFilteredProductsByType, selectSortedProducts, setFilteredProductsByType, setSortedProducts } from './productSlice'
                                            ...
                                            {renderSortedProducts.map((product) => (
                                                ...
                                                >
                                                    ...
                                                    <div className="mt-4 mx-3">
                                                        ...
                                                        <div className='flex mt-1 w-full justify-between mb-2'>
                                                            <p className="text-sm font-medium text-gray-900 translate-y-2">{product.price}</p>
