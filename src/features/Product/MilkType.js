...
const filters = [
  {
    ...
    name: "Milk Type",
    options: [
      { value: "Whole-milk", label: "Whole Milk", checked: false },
      { value: "Skimmed-milk", label: "Skimmed Milk", checked: false },
      { value: "Raw-milk", label: "Raw Milk", checked: false },
      { value: "Low-fat-milk", label: "Low-fat Milk", checked: false },
      { value: "Full-cream-milk", label: "Full cream Milk", checked: false },
      { value: "Buttermilk", label: "Buttermilk", checked: false },
    ],
  },
  {
    id: "quantity",
    ...
    options: [
      ...
      { value: "5l", label: "5L", checked: false },
      { value: "10l", label: "10L", checked: false },
      { value: "15l", label: "15L", checked: true },
...
export default function MilkType() {
  ...
  const renderProducts =
    filteredProducts.length > 0 ? filteredProducts : productsKeys;
  const renderFilteredProducts =
    filteredProductsByType.length > 0 ? filteredProductsByType : renderProducts;
  const renderSortedProducts =
    sortedProducts.length > 0 ? sortedProducts : renderFilteredProducts;
  ...
  const handleFilterChange = (e, section, option) => {
    ...
    axios
      .post("http://localhost:5001/auth/filterByType", { type: selectedTypes })
      .then((res) => {
  ...
  const handleSortProduct = (e, option) => {
    ...
    axios
      .post("http://localhost:5001/auth/sort", {
        sort: option.sortBy,
  ...
  const handleProductOverview = (productId) => {
    navigate(`/productOverview/${productId}`);
  };
                  ...
                  <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-1 lg:max-w-7xl lg:px-0">
                    <div className="grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-4">
                      {renderSortedProducts.map((product) => (
                        <Link
                          key={product.id}
                          onClick={() => handleProductOverview(product.id)}
                        >
                          <div className="group relative border border-green-200 hover:border-green-500 hover:shadow-xl rounded">
