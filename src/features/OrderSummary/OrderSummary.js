                ...
                <main className="flex-1 pb-8">
                    <div className="max-w-2xl mx-auto sm:py-14 sm:px-6 lg:max-w-7xl lg:px-8">
                        <div className="px-4 space-y-4 sm:px-0 sm:items-baseline sm:justify-between sm:space-y-0">
                            <h1 className="mb-2 text-sm font-semibold uppercase tracking-wide text-indigo-600">Thank you!</h1>
                            <p className="mt-2 pb-2 text-3xl font-extrabold tracking-tight sm:text-5xl">It's on the way!</p>
                            <p className="mt-2 pb-2 text-base text-gray-500">Your order #14034056 has shipped and will be with you soon.</p>
