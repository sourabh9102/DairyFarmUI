...
export const { setFilteredProducts, setFilteredProductsByType, setSortedProducts, updateFilterOptions } = productSlice.actions;

export const selectAllProducts = (state) => state.product.products;
export const selectFilteredProducts = (state) => state.product.filteredProducts;
export const selectFilteredProductsByType = (state) => state.product.filteredProductsByType;
