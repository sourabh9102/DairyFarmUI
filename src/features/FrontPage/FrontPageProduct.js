...
import { selectAllProducts, fetchAllProductsAsync } from '../Product/productSlice';
import {
    Card,
    CardHeader,
    CardBody,
...
function FrontPageProduct() {
    ...
    const RenderModal = () => {
        ...
        const selectedProductData = selectedProduct ? products.find((product) => product.id === selectedProduct) : null;
    ...
    return (
        <>
            <Link
                className={'fixed bottom-4 right-4 p-2 text-2xl text-blue-gray-600 hover:text-blue-gray-900'}
                onClick={scrollToTop}
            >
                <FaChevronUp />
            </Link>
                ...
                <div className='mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-16 lg:max-w-7xl lg:px-8'>
                    <div className='flex justify-between'>
                        ...
                        <div className='flex space-x-2'>
                            <CiCircleChevLeft size={30} className='text-light-green-600 cursor-pointer' onClick={handlePrevPage} />
                            <CiCircleChevRight size={30} className='text-light-green-600 cursor-pointer' onClick={handleNextPage} />
                        </div>
                    </div>
